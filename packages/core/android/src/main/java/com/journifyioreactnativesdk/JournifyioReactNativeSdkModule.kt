...
@ReactModule(name="JournifyioReactNativeSdk")
class JournifyioReactNativeSdkModule : ReactContextBaseJavaModule, ActivityEventListener, LifecycleEventListener {
  ...
  override fun initialize() {
   ...
   override fun getName(): String {
       return "JournifyioReactNativeSdk"
   }
...
/**
  ...
  companion object {
    const val NAME = "JournifyioReactNativeSdk"
  }
}
