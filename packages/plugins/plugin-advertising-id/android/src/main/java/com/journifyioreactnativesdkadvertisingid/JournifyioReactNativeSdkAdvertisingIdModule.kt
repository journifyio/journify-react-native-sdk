package com.journifyioreactnativesdkadvertisingid
...
@ReactModule(name="JournifyioReactNativeSdkAdvertisingId")
class JournifyioReactNativeSdkAdvertisingIdModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {

  override fun getName(): String {
    return "JournifyioReactNativeSdkAdvertisingId"
}
